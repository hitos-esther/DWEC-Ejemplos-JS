...
console.log(`Conversión a hexadecimal: ${num.toString(16)}`);  // en base 16: ff, de decimal a base
console.log(`Conversión a octal: ${num.toString(8)}`);  // en base 8: 377, de decimal a base
console.log(`Conversión a binario: ${num.toString(2)}`);   // en bae 2: 11111111, de decimal a base
console.log(`Conversión a base 35: ${num.toString(35)}`); // en base 36: 73, de decimal a base
...
console.log("----------parseInt(cadena, base) y parseFloat()----------");
...
console.log(parseInt(cadenaBinaria, 2)); // ¡CUIDADO! No confundir con toString(2), de base a decimal
console.log(parseInt(cadenaOctal, 8)); // ¡CUIDADO! No confundir con toString(8)
console.log(parseInt(cadenaHexa, 16)); // ¡CUIDADO! No confundir con toString(16)
console.log(parseFloat(cadenaNumero));

console.log("----------parseInt(numero, base)----------");
num = 255;
cadenaBinaria = 11111111;
cadenaOctal = 377;
cadenaHexa = "FF";
console.log(parseInt(cadenaBinaria, 2));
console.log(parseInt(cadenaOctal, 8));
console.log(parseInt(cadenaHexa, 16));
console.log("----------***********----------");
console.log(parseInt(cadenaBinaria));
console.log(parseInt(cadenaOctal));
console.log(parseInt(cadenaHexa));

console.log("----------¿POR QUÉ TANTO LÍO?----------");
parteDecimal = 5.4321;
console.log(parteDecimal - Math.floor(parteDecimal)); // 5.4321 - 5 != 0.4321, 0.43210000000000015
